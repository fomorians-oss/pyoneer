...
def funk_svd_solve(matrix,
    ...
    for e in range(max_epochs):
        ...
        lr_ = lr() if callable(lr) else lr
        x += lr_ * (x_update - l2_scale * x)
        y += lr_ * (y_update - l2_scale * y)
