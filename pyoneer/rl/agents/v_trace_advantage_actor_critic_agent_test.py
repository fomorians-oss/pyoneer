...
from pyoneer.rl.agents import v_trace_advantage_actor_critic_agent_impl
from pyoneer.rl.agents.test import policy_value_test_case_impl


class VTraceAdvantageActorCriticAgentTest(policy_value_test_case_impl.PolicyValueTestCase):
    ...
    def testConvergenceDiscrete(self):
        with context.eager_mode():
            ...
            agent = v_trace_advantage_actor_critic_agent_impl.VTraceAdvantageActorCriticAgent(
                policy=self.policy, 
