...
from pyoneer.regularizers.regularizers_impl import (
    ConcreteDropout as ConcreteDropoutRegularizer,
    DropoutL2,
)
...
class RegularizersTest(tf.test.TestCase):
    def test_concrete_dropout(self):
        ...
        regularizer = ConcreteDropoutRegularizer(dropout_layer, scale=1.0)
